...
public class Tools {
    ...
    // 设置Table样式
    public static void setFullTableStyle(JTable jtb) {
...
class TableRenderer extends DefaultTableCellRenderer {
    public Component getTableCellRendererComponent(JTable table, Object value,
        ...
        //System.out.println("ColumnCount---"+table.getColumnCount()+"   row---"+row+"   column---"+column);
        for (int i = 0; i < table.getColumnCount(); i++) {
           // Object NumberValue = table.getValueAt(i, 1);
            //System.out.println(i + "-------" + NumberValue + "---" + NumberValue.equals(pathNumber));
            if (value.equals("1")) {
